#line 2 "/usagers/kajula/Documents/LOG6302_TP/LOG6302_TP/doxygen-master/generated_src/pre.cpp"

#line 4 "/usagers/kajula/Documents/LOG6302_TP/LOG6302_TP/doxygen-master/generated_src/pre.cpp"
...
FILE *preYYin = NULL, *preYYout = NULL;
...
static yyconst flex_uint16_t yy_base[1467] =
    {   0,
...
static yyconst flex_uint16_t yy_nxt[6578] =
    {   0,
...
#line 4321 "/usagers/kajula/Documents/LOG6302_TP/LOG6302_TP/doxygen-master/generated_src/pre.cpp"
 ...
 * we now use fwrite().
 */
#define ECHO do { if (fwrite( preYYtext, (size_t) preYYleng, 1, preYYout )) {} } while (0)
#endif
...
#define YY_INPUT(buf,result,max_size) \
	if ( YY_CURRENT_BUFFER_LVALUE->yy_is_interactive ) \
		...
		{ \
		errno=0; \
		while ( (result = (int) fread(buf, 1, (yy_size_t) max_size, preYYin)) == 0 && ferror(preYYin)) \
			{ \
			if( errno != EINTR) \
				{ \
				YY_FATAL_ERROR( "input in flex scanner failed" ); \
...
#line 4587 "/usagers/kajula/Documents/LOG6302_TP/LOG6302_TP/doxygen-master/generated_src/pre.cpp"
...
ECHO;
	YY_BREAK
#line 6777 "/usagers/kajula/Documents/LOG6302_TP/LOG6302_TP/doxygen-master/generated_src/pre.cpp"
...
"input buffer overflow, can't enlarge buffer because scanner uses REJECT" );
	...
	if ((int) ((yy_n_chars) + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) preYYrealloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,(yy_size_t) new_size  );
    ...
    YY_BUFFER_STATE preYY_create_buffer  (FILE * file, int  size )
{
	 ...
	 */
	b->yy_ch_buf = (char *) preYYalloc((yy_size_t) (b->yy_buf_size + 2)  );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in preYY_create_buffer()" );
...
YY_BUFFER_STATE preYY_scan_string (yyconst char * yystr )
{
	...
	return preYY_scan_bytes(yystr,(int) strlen(yystr) );
}
